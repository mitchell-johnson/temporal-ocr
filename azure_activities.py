...
from shared import DocumentInput, OcrActivityResult, SummarizationActivityResult, AzureOpenAIActivities
...
class AzureOpenAIActivitiesImpl(AzureOpenAIActivities):
    ...
    def __init__(self):
        ...
        self.client = AsyncAzureOpenAI(
            api_key=api_key,
            api_version="2024-12-01-preview",  # Latest version supporting vision
    ...
    async def perform_azure_ocr(self, doc_input: DocumentInput) -> OcrActivityResult:
        ...
        try:
            ...
            Preserve the exact formatting, spacing, and structure of the text as it appears in the document.
